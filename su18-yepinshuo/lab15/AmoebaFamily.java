...
public class AmoebaFamily implements Iterable<AmoebaFamily.Amoeba> {
    ...
    public class AmoebaDFSIterator implements Iterator<Amoeba> {
        ...
        public Amoeba next() {
            ...
            Amoeba newAmoeba = fringe.pop();
            Collections.reverse(newAmoeba.children);
            for (Amoeba a : newAmoeba.children) {
                fringe.push(a);
            }
            return newAmoeba;
        }
    ...
    public class AmoebaBFSIterator implements Iterator<Amoeba> {
        ...
        public Amoeba next() {
            ...
            Amoeba newAmoeba = fringe.remove(0);
            for (Amoeba a : newAmoeba.children) {
                fringe.add(a);
            }
            return newAmoeba;
